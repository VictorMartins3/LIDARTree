...
file_directory = r'C:/Users/Victor Martins/Desktop/agoravai/downsampledlesscloudEURO6.pcd'
...
PointCloud = pclpy.pcl.PointCloud.PointXYZ()
pclpy.pcl.io.loadPCDFile('C:/Users/Victor Martins/Desktop/agoravai/downsampledlesscloudEURO6.pcd',PointCloud)
...
from scipy.optimize import linear_sum_assignment
import sys 
sys.path.insert(0, 'C:/Users/Victor Martins/Desktop/agoravai/TreeTool/treetool')

import utils
# Get ground truth
tree_data = pd.read_csv('C:/Users/Victor Martins/Desktop/agoravai/TreeTool/results/myresults.csv', sep=',', skiprows=1, names=['X', 'Y', 'Z', 'DBH'])
